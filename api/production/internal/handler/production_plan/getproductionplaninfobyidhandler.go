...
func GetProductionPlanInfoByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetProductionPlanInfoByIdReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := production_plan.NewGetProductionPlanInfoByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetProductionPlanInfoById(&req)
