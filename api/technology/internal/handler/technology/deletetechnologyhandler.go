...
func DeleteTechnologyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteTechnologyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := technology.NewDeleteTechnologyLogic(r.Context(), svcCtx)
		resp, err := l.DeleteTechnology(&req)
