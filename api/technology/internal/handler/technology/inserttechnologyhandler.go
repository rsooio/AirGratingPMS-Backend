...
func InsertTechnologyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InsertTechnologyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := technology.NewInsertTechnologyLogic(r.Context(), svcCtx)
		resp, err := l.InsertTechnology(&req)
