...
func GetWorkshopListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetWorkshopListReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := workshop.NewGetWorkshopListLogic(r.Context(), svcCtx)
		resp, err := l.GetWorkshopList(&req)
