...
func UpdateEnterpriseInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateEnterpriseInfoReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := enterprise.NewUpdateEnterpriseInfoLogic(r.Context(), svcCtx)
		resp, err := l.UpdateEnterpriseInfo(&req)
