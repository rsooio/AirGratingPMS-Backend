...
func (l *FindListByEnterpriseLogic) FindListByEnterprise(in *pb.FindListByEnterpriseReq) (*pb.TechnologyList, error) {
	list, count, err := l.svcCtx.TechnologyModel.FindListByEnterprise(l.ctx, in.EnterpriseId, (in.PageNumber-1)*in.PageSize, in.PageSize)
