...
func (l *FindListByWorkshopLogic) FindListByWorkshop(in *pb.FindListByWorkshopReq) (*pb.ClientList, error) {
	list, count, err := l.svcCtx.ClientModel.FindListByWorkshop(l.ctx, in.EnterpriseId, in.WorkshopId, (in.PageNumber-1)*in.PageSize, in.PageSize)
